...
echo "Installing AwesomeWM (blackburn) on Gentoo"
...
if [ -f "$HOME/.config/awesome/themes/blackburn/theme.lua" ]; then
    ln -sf "$HOME/.config/awesome/themes/blackburn" "$HOME/.config/awesome/theme"
fi
...
echo "AwesomeWM blackburn theme installed successfully!"
