...
echo "Installing AwesomeWM (default) on Gentoo"
...
if [ -f "$HOME/.config/awesome/themes/default/theme.lua" ]; then
    ln -sf "$HOME/.config/awesome/themes/default" "$HOME/.config/awesome/theme"
fi
...
echo "AwesomeWM default theme installed successfully!"
