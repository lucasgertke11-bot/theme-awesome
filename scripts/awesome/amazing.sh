...
echo "Installing AwesomeWM (amazing) on Gentoo"
...
if [ -f "$HOME/.config/awesome/themes/amazing/theme.lua" ]; then
    ln -sf "$HOME/.config/awesome/themes/amazing" "$HOME/.config/awesome/theme"
fi
...
echo "AwesomeWM amazing theme installed successfully!"
